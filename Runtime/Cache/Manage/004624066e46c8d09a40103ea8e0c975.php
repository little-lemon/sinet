    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                ...
                <button class="btn btn-default" type="button" onclick="doGoSubmit('<?php echo U('qk');?>','form_do')"><em class="glyphicon glyphicon-th-list"></em> 更新常用菜单</button>
            </div>
        </div>
    </div>
