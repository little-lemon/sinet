...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/sim.php?s=';
	    var SELF='/sim.php?s=/Article/index/pid/41';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td><?php echo (date('Y年m月d日 H:i:s', $v["publishtime"])); ?></td>
                            <td class="text-right">
                            <?php if(ACTION_NAME == "index"): ?><a href="<?php echo (view_url($v)); ?>" target="_blank" class="label label-info">查看</a>
                            <a href="<?php echo U('edit',array('id' => $v['id'],'pid' => $pid), '');?>" class="label label-success" target="_self">编辑</a>
