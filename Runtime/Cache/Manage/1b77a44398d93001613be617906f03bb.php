...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/sim.php?s=';
	    var SELF='/sim.php?s=/Menu/edit/id/5';
		...
		<div class="col-lg-12">
				...
				<form method='post' class="form-horizontal" id="form_do" name="form_do" action="<?php echo U('edit');?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="name" id="inputName" value="<?php echo ($data["name"]); ?>" class="form-control" placeholder="菜单名称" required="required" />		
						</div>
					</div>
					<div class="form-group">
						<label for="inputModule" class="col-sm-2 control-label">模块名</label>
						<div class="col-sm-9">
							<input type="text" name="module" id="inputModule" value="<?php echo ($data["module"]); ?>" class="form-control" placeholder="模块名：首字母大写" />	
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="action" id="inputAction" value="<?php echo ($data["action"]); ?>" class="form-control" placeholder="方法名：首字母小大写" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="parameter" id="inputParameter" value="<?php echo ($data["parameter"]); ?>" class="form-control" placeholder="附加参数" />	
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="sort" id="inputSort" value="<?php echo ($data["sort"]); ?>" class="form-control" placeholder="排序" />	
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							...
							<input type="radio" name="status" value="1" <?php if($data["status"] == 1): ?>checked="checked"<?php endif; ?> />显示</label>
							<label class="radio-inline">
							<input type="radio" name="status" value="0" <?php if($data["status"] == 0): ?>checked="checked"<?php endif; ?> />隐藏</label>
						</div>
					</div>				
