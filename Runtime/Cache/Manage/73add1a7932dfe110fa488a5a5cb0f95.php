...
<head>
	...
	<script language="JavaScript">
	    ...
	    var APP	 = '/sim.php?s=';
	    var SELF='/sim.php?s=/Category/index';
    ...
    <div class="row margin-botton">
        <div class="col-md-6 column">
            <div class="btn-group btn-group-md">
                 <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('Category/add');?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加菜单</button>
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($cate)): foreach($cate as $key=>$v): ?><tr>
                                ...
                                <a href="<?php echo U('Category/add',array('pid' => $v['id']));?>" class="label label-primary">添加子菜单</a>
